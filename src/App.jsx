...
const App = () => {
  ...
  const { loading, data, error } = useFetch(`https://api.weatherapi.com/v1/current.json?key=${APIKEY}&q=${location}&aqi=no`)
  ...
  return (
    <div id="App">
      <UserInteraction setLocation={setLocation} errorOccurred={!!error} errorMessage={error}/>      
